...
{
	int size1 = 6, size2 = 4;
	int tofind1 = 2, tofind2 = 100;
	std::cout << "===========================" << std::endl;
	std::cout << "VECTOR TESTS:" << std::endl;
	vector_test(size1, tofind1);
	vector_test(size2, tofind2);
	std::cout << "===========================" << std::endl;
	std::cout << "LIST TESTS:" << std::endl;
	list_test(size1, tofind1);
	list_test(size2, tofind2);
	std::cout << "===========================" << std::endl;
	std::cout << "DEQUE TESTS:" << std::endl;
	deque_test(size1, tofind1);
	deque_test(size2, tofind2);
}