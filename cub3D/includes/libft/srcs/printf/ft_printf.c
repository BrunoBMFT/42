...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/29 00:35:21 by brfernan          #+#    #+#             */
/*   Updated: 2024/12/20 02:20:53 by brfernan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_printf(const char *str, ...)
{
	...
	while (str[++i])
	{
		if (str[i] == '%')
		{
			while (!is_possible(POSSIBLE_PF, str[i + 1]))
				i++;
			if (is_possible(POSSIBLE_PF, str[i + 1]))
